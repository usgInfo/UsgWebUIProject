...
{
//added for auto gentaration of rows on 11th oct
...
//                        + "<td style='cursor:pointer;'><input type='text'  id='" + crAmountId + "' class='crAmount form-control' onkeypress='return isNumberKeyValidation(this,event);' placeholder='Cr.Amount'  onblur='checkDrCrAmountAndAddEntry()' value='" + ledgerList[i].crAmount + "'></td>"
                        + "<td style='cursor:pointer;'><input type='number' id='" + drAmountId + "'  class='drAmount form-control'  onkeypress='return isNumberKeyValidation(this,event);' placeholder='Dr.Amount'   onchange=addReceiptVoucherRows('displayReceiptVoucherAddTableBody'); value='" + ledgerList[i].drAmount + "'></td>"
                        + "<td style='cursor:pointer;'><input type='t'  id='" + crAmountId + "' class='crAmount form-control' onkeypress='return isNumberKeyValidation(this,event);' placeholder='Cr.Amount'  onchange=addReceiptVoucherRows('displayReceiptVoucherAddTableBody'); value='" + ledgerList[i].crAmount + "'></td>"
...
//            
            ...
            if (numberofRows == 1)
            {
                $("#" + DivId).append("<tr id='" + id + "' style='cursor:pointer;' >"
                        ...
                        + "<td style='cursor:pointer;'><select  type='text' name='group' id='" + groupId + "' onchange=getLedgerListForOptions('" + groupId + "','" + ledgerId + "')></select> <br><select  type='text' name='ledger' id='" + ledgerId + "'></select></td>"
                        + "<td style='cursor:pointer;'><input id='" + drAmountId + "' class='drAmount form-control' type='text' placeholder='Dr.Amount'   onkeypress='return isNumberKeyValidation(this,event);' onchange=addReceiptVoucherRows('displayReceiptVoucherAddTableBody'); disabled></td>"
                        + "<td style='cursor:pointer;'><input id='" + crAmountId + "' class='crAmount form-control' type='text' placeholder='Cr.Amount'  onkeypress='return isNumberKeyValidation(this,event);' onchange=addReceiptVoucherRows('displayReceiptVoucherAddTableBody');   disabled></td>"
...
function  updateReceiptVoucher(obj) {
    ...
    obj = JSON.parse(obj);
    viewReceiptVoucherAddList('receiptVoucherlistAddpanelRow');
    addReceiptVoucherRows("displayReceiptVoucherAddTableBody", obj.ledgerList, "Update");
    var isGrant = "";
    globalTotalBankAmount = 0;
    globalTotalChequeAmount = 0;
    if (obj.isGrant == "Yes") {
